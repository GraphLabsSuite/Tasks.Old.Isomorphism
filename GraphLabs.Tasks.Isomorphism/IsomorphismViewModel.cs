...
{
    /// <summary> ViewModel для Isomorphism </summary>
    public partial class IsomorphismViewModel : TaskViewModelBase<Isomorphism>
    {
        ...
        public static readonly DependencyProperty IsLoadingDataProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.IsLoadingData), 
            typeof(bool), 
            typeof(IsomorphismViewModel),
        ...
        public static readonly DependencyProperty IsMouseVerticesMovingEnabledProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.IsMouseVerticesMovingEnabled),
            typeof(bool),
            typeof(IsomorphismViewModel),
        ...
        public static readonly DependencyProperty IsEdgesAddingEnabledProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.IsEgesAddingEnabled),
            typeof(bool),
            typeof(IsomorphismViewModel),
            new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty Phase3ToolBarCommandsProperty = DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.Phase3ToolBarCommands),
        ...
        public static readonly DependencyProperty GivenGraphProperty =
            ...
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.GivenGraph),
            typeof(IGraph),
            typeof(IsomorphismViewModel),
        ...
        public static readonly DependencyProperty IsomorphismResultProperty =
            DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.IsomorphismResult),
            typeof(bool),
            typeof(IsomorphismViewModel),
            new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty BackgroundGraphProperty =
            DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.BackgroundGraph),
            typeof(IGraph),
            typeof(IsomorphismViewModel),
            new PropertyMetadata(default(IGraph)));
        ...
        public static readonly DependencyProperty WorkspaceGraphProperty =
            DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.WorkspaceGraph),
            typeof(IGraph),
            typeof(IsomorphismViewModel),
            new PropertyMetadata(default(IGraph)));
        ...
        public static readonly DependencyProperty WorkspaceGraphVisibilityProperty =
            DependencyProperty.Register(
            ExpressionUtility.NameForMember((IsomorphismViewModel m) => m.WorkspaceGraphVisibility),
            typeof(Visibility),
            typeof(IsomorphismViewModel),
